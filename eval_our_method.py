...
#print(args.match_model)
#init_matching_model(args.match_model)
...
jsonl_path = f"eval_utils/descriptions_{args.extraction_model}.jsonl"
...
def process_images_with_model(gt_json_path, detection_model):
...
process_images_with_model(gt_json_path, model)
