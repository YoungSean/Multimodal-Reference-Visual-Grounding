...
image_folder = "/metadisk/label-studio/scenes"  #"scenes" 
...
jsonl_path = "eval_utils/descriptions_gpt-4o-2024-08-06-1.jsonl"
...
model = NIDS_PE(object_features, use_adapter=True, adapter_path=weight_adapter_path, use_class_token=True, gdino_threshold=0.4, class_labels=labels, model_name = "PE-Core-L14-336")
...
#        total_size += len(gt_anns)
    ...
    with open(f'results/NIDS-Net_PE_L_cls_token_adapted_predictions_{args.extraction_model}.json', 'w') as f:
