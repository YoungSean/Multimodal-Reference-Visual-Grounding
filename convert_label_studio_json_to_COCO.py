...
def convert_to_coco_format(data):
    ...
    for item in data:
        ...
        coco_output["images"].append({
            ...
            "width": width,
            "height": height,
            "file_name": f"{image_name}.jpg"  # Adjust filename if necessary
        })
...
# Example usage
input_path = '/metadisk/label-studio/project8.json'  # Path to your input annotation file
output_path = '/metadisk/label-studio/project8_coco.json'  # Path to save COCO-formatted annotations
